...
- [ ] **v1.2 GAP-01** — тихая распаковка при открытии архива из ОС (`/gsd:plan-phase 9`)
- [ ] **v1.2 GAP-02** — ПКМ Win/Linux ближе к «из коробки» (фаза 10)
...
- **GAP-01:** `open-files` / двойной щелчок → распаковка **без** главного окна (или эквивалент).
...
| v1.2: честные статусы ТЗ + GAP вместо переоценки «всё [x]» | Заказчик ожидает дословное соответствие | — Pending |
